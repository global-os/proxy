    ...
    <Page>
      <VerticalFrame width="380px">
        <div className="w-full px-2 pb-4">
          <h2 className="text-lg font-semibold text-gray-700 mb-5 pb-2 border-b border-gray-300">
            Log In
          </h2>
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#ddd] px-2 text-gray-500">or continue with</span>
            </div>
          </div>
          ...
          <div className="grid gap-2">
            <button
              ...
              className="w-full py-2 px-4 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 transition-colors cursor-pointer flex items-center justify-center gap-2"
            >
